                            ...
                            child:SingleChildScrollView(child:Column(
                              children: [
                               ...
                               Padding(
                                ...
                                currentCheckout.value.deliveryPossible && currentCheckout.value.grand_total>0 && currentCheckout.value.sub_total>=setting.value.minimum_purchase && currentUser.value.name!=null && currentUser.value.name!='' && currentUser.value.phone!=null?  Column(
                           ...
                           children:[
                             Container(
                               margin: EdgeInsets.only(top:20),
                                ...
                                ): currentCheckout.value.sub_total<setting.value.minimum_purchase && _con.paymentLoading==false ?Column(
                                  children: [
