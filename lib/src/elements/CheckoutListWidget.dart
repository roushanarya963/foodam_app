    ...
    return Container(
      child: SingleChildScrollView(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            setting.value.deliveryTips &&  currentCheckout.value.deliverType!=3 ?Container(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    ...
                    child: currentCheckout.value.deliveryTimeSlot != null
                        ...
                        style:
                        Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).colorScheme.secondary, fontWeight: FontWeight.w600)))
